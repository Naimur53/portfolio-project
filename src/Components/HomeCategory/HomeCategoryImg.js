...
const HomeCategoryImg = ({ title, thumbnail, _id }) => {
    ...
    return (
        <Link href={'/category/' + _id} className='overflow-hidden block text-gray-50 transition duration-300 brightness-50 hover:brightness-100 grayscale hover:grayscale-0  pb-20 w-full relative'>
